      ...
      <Wrapper>
        <StyledDiv>
          ...
          <div>
            ...
            <br />
            <StyledPar>Through True Rich Attended does no end it his mother since real had half every him.</StyledPar>
          </div>
          <div>
            <StyledAiFillDollarCircle />
        ...
        <StyledDiv>
          ...
          <form action="#">
            ...
            <StyledButton type="button">Get your quote</StyledButton>
          </form>
        </StyledDiv>
      </Wrapper>
    </div>
